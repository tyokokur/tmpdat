...
- [-] b5v4c1: b2.5 v2.34
  - c3.1 no peak at all
  - WIP c3.15 (f515) --> 7,9,10 still going
  - c3.2 (f250) transition too far left
- [-] f2{0..4}: b2.2 v1.23 c3.1
  - v1.23, v1.24 
  - *BEST* v1.20 (f201)
    - \kappa_D 4.5 is better, but increase not dramatic enough
    - WIP \kappa_D 3.5 and 3.0 to see if can reach correct heights just later
...
* PROG int_ NFH
- If good, add to characterization section of paper
...
- [-] 1C - 1C (\chi 2.0)
  - H \approx 25 (single)
  - Run Lx = [100, 90, 80, 70, 60, 50, 40] first.
    - If works, check interaction and make finer or expand, etc.
- [ ] 1Cd - 1Cd (\alpha 0.2, \chi 0.8?)
- [-]  2C - 2C (\chi 1.75)
  - DO THIS AFTER 1C CHECK
