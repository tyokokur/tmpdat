...
- [-] a1C [2023-04-07 Fri 14:05]
  - ./{1..5} still running
- [-] a1D [2023-04-07 Fri 14:06]
  - ./{1..6} still running
  - ./7 rerun
- [-] a1E [2023-04-07 Fri 14:08]
  - ./{1,2,3,5,6} still running
  - 80 running [2023-04-10 Mon 14:14]
- [-] a1F [2023-04-10 Mon 14:20]
- [-] a2C [2023-04-07 Fri 14:08]
  - ./{1..7} still running
- [-] a2D [2023-04-07 Fri 14:09]
  - ./{2,3,5,6} still running
- [-] a2E [2023-04-07 Fri 14:09]
  - ./{1..7} still running
- [-] b1C [2023-04-07 Fri 14:25]
  - ./{1,2,3,4,5,7} still running
- [-] b1D [2023-04-07 Fri 14:26]
  - ./{1,2,3,4,6} still running
- [-] b1E [2023-04-07 Fri 14:27]
  - ./{1..5} still running
  - 80 running [2023-04-10 Mon 14:14]
- [-] b1F [2023-04-10 Mon 14:20]
- [-] g1C [2023-04-07 Fri 14:28]
  - ./{1..6} still running
- [-] g1D [2023-04-07 Fri 14:29]
  - ./{1..5} still running
- [-] g1E [2023-04-07 Fri 14:29]
  - ./{1,3,5} still running
  = ./2 rerun

- [-] HC [2023-04-07 Fri 13:56]
  - ./5 still running
  - ./6 nan
- [X] HD [2023-04-07 Fri 13:55]
- [-] HE [2023-04-07 Fri 13:56]
  - ./{1,2,3,5,8} still running
  - ./4 rerun
- [-] HF [2023-04-10 Mon 14:17]
- [X] La1 [2023-04-07 Fri 13:51]
- [-] La2 [2023-04-07 Fri 13:52]
  - ./{1,2,3,5} still running
...
- pNFL
  - Necessary? Only difference is 2 residues at beginning of chain (\Delta\alpha
    = 0.05 for Block 1)

- pNFH
  - pH1: b0.50 v0.13 c3.00
    - Test to see what happens; params previously used for native NFH
    - Overshot exp H prof
  - [-] pH2: b0.50 v0.10 c3.00
    - Moderate v to lower H; params also work for native
    - ./3 
      - wparams 1e-04, 200 --> andit 3000; went 3e5 its and flatlined
      - wparams 1e-03, 50, andit 3000, Ns1200
  - [-] pH3: b0.50 v0.20 c3.00
    - Rerun 2 from finished ./3
      - 1e-03, 80 --> 1e-03, 30 --> 1e-03, 50
  - [-] pH4: b0.50 v0.30 c3.00
    - Get ./7 to work first
      - 1e-03, 30, andit 2000, Ns1200; Diverge at 6000
      - 1e-03, 50, andit 3000, Ns1200; Diverge at 87000
      - 1e-03, 30, andit 1000, Ns1500; Stoped at 5000
      - 1e-03, 40, andit 2000, Ns1500; Worked
    - Init ./6 from ./7 
      - 1e-03, 40, andit 2000, Ns1000; Worked
    - Init ./{4,5} from ./6
