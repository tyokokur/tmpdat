...
- [-] f2{0..4}: b2.2 v1.23 c3.1
  - v1.23, v1.24 makes less slightly less sharp
  - v1.20 WIP (f201)
...
** PROG Mixture coding
- Run: \sigma 0.030; Nm 150; \alpha 0.30; \chi 1.5
Verification runs (NLH/test/)
- orig: original from NLH/EAD*
- single: new with 1 protein
- double: 2
- triple: 3
** TODO Mixture runs
** Calculations
