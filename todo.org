...
- 4 mM: NFH_ 04
  ...
  - [X] H04d: Lx = [29..19..-1]
    - Sep: [14.5..11.5]
    - Con: [11.0..9.5]
  - [ ] H04e: Lx = [9.5..20..2] (condensed)
- 6 mM: NFH_ 06
  - [X] H06a: Lx = [78..30..-2]
  - [X] H06b: Lx = [150..80]
  - [X] H06c: Lx = [30..10..-1]
  - [ ] H06d: Lx = [11.5..30..1] (condensed)
- 50 mM: NFH_ 50
  - [-] H50s: Lx = [150..25]
  - [X] H50c: Lx = [46..10]
  - [-] H50c2: Lx = [50..70..4]
    - Rerunning ./7 from ./8 since nan
...
- Failed: in= -1
- Failed: in = 0, 0.40
- Try andit 5000 (only b5v1c2)
- [-] Try b0.75 instead (only b5v1c2)
...
- [-] 1C - 1C (\chi 2.0; p1a4s02/27)
  ...
  - c2520: D = [25..20..-1], (in = 0, 0.90)
    - [-] ./{1,2} redo
      - If doesn't work, don't really need
  - c1915: D = [19..15..-0.5], (in = 0, 0.90)
    - D = 17.5 seems to be max realistic pha
  - s3020: D = [30..20..-1]
  - s1915: D = [19..15..-0.5], init from s3020/21
    - [-] Redo; Start with 19 from s3020/22
    - [-] Redo; Change ./3,4 to D = 19.5 from s3020/22
