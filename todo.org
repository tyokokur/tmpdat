...
- [-] pH3: b0.50 v0.20 c3.00
  ...
  - Try 2.0e-03 to see if easier to conv then do 1.5e-03
    ...
    - Currently rerunning W_ 1in.dat with Lx120

      
    - Rerun from W_ 1in.dat; 1e-03, 70, andit 2000, Lx 120 
- pH4: b0.50 v0.30 c3.00
    
** PROG Phos M pure
- pM1: b0.50 v0.20 c3.00
  - ./0 starting with in = 0
  - Rerun from W_ in; andit 0
    - it 50000, anderr 0.4
    - ../W_ 0in.dat created 
  - Rerun from ../W_ 0in.dat; 1e-03, 50, 1000 [2023-05-01 Mon 15:05]
  - ./{1..7} running from ./0/W_ a* (almost done) [2023-05-01 Mon 16:25]
