...
- 1-1-1: Nx[46..44] (seed p2b/18, Nx42)
  - ./{1..6} working for 1-1-1 [2023-11-21 Tue 17:05]
  
*** p2d
- 1-1: Nx[41..35] (seed p2b/18) 
  - ./1,2: Nx41.8,41.7 (1-1)
  - ./3,4: Nx41.5,41.4 ./3 prog, ./4 waiting on result [2023-11-21 Tue 18:26]

*** p2c (seed int_ SYSGp2/5; D30)
- p24C Nx [60..50..-1] 
  - 60..57: 2+2 [2023-11-21 Tue 19:05]
  - 56    : 3+3
  - 55..52: 2+2 /may need to use w-in change/
  - 51..50: 1+1+1
  - DONE: ./{1,2,3,4,19,20,21,22}
    - {60.2..59} (2-2)
    - {51.2..50} (1-1-1)
