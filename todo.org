...
- [-] pH3: b0.50 v0.20 c3.00
  - ./1: 1e-04, 50, 5000, 1500
  - ./1: 5e-04, 70, 5000, 1500 [2023-06-13 Tue 13:36]
- pH4: b0.50 v0.30 c3.00
- For better fit, decrease b and aim for v from H1 and H2
  - pH5: b0.45 v0.15 c3.00
    - ./1: Init from ./2 [TERMINAL]
    - ./2: See if running more helps, otherwise done (anderr 2e-03) [2023-06-13 Tue 15:40]
    - ./3: See if running more helps, otherwise done (anderr 3e-03) [2023-06-13 Tue 15:40]
