...
* DONE int_ NFH -- Do same process when NFH fitting done
- int_ NFH looks good
...
- int_ NFH3 focus on moving brushes closer
  - Force not monotonic; splice error or interaction btw brushes?
- int_ NFH4 continue moving closer
  - Formation of overlapping layer
...
- b5.0 v20 c3.0 (L_ 523): next b0 up
  - If not sharp enough, needs to have enough \phi to go down and H
    profile to go down373)
  - b3 v7 c5.0 (L_ 375): \chi u
...
- [-] 1C - 1C (\chi 2.0)
  ...
  - p1_ 3: D = [9..6..-1]
  - [-] p1_ f1: D = [8.9, 8.8, 8.7, 8.6, 8.5, 8.4, 8.3, 8.2, 8.1]
  - [-] p1_ f2: D = [7.9..7.1..-0.1]
- 1Cd - 1Cd (\alpha 0.2, \chi 0.8?)
- [ ]  2C - 2C (\chi 1.75)
  - [ ] p2_ 1: D = [50..20..-5]
    - Starting out as p1; check in==-1 for int.c
