...
- 4 mM: NFH_ 04
  ...
  - [X] H04d: Lx = [29..19..-1]
    - Sep: D = [14.5..11.5]
    - Con: D = [11.0..9.5]
  - [X] H04e: Lx = [24..48..4] (condensed)
  - Sweep finished
    - Smooth out force curve
      - Con
        - [-] Add to H04e: D = [11, 13, 15]
      - Sep
        - [-] From H04d: D = [14.5..11.5](./13..22); Ns inc?
        - [-] From H04a: D = [78..30]; Ns inc?
- 6 mM: NFH_ 06
  - [X] H06a: Lx = [78..30..-2]
  - [X] H06b: Lx = [150..80]
  - [X] H06c: Lx = [30..10..-1]
  - [-] H06d: Lx = [25..60..5] (condensed)
    - [-] Con H06d.{9.10}: Extend to D = 22.5 to make cross clear
- 50 mM: NFH_ 50
  - [X] H50s: Lx = [150..25]
  - [X] H50c: Lx = [46..10]
  - [X] H50c2: Lx = [50..70..4]
    - Do 2 more condensed and 2 more sep to make cross more apparent
    - Calculate exact crossing and interpolate to make min. freeE line
