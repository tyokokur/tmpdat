...
- [-] L1
  - L: b1.50 v2.70 c3.20
    - ./8 fin; rerun {1..7} using Lx 40
  - H: b0.75 v0.10 c3.20
    - ./7,8 fin; rerun {1..6} using Lx 40
- [-] L2
  - L: b1.75 v2.70 c3.20
    - ./7,8 fin; rerun {1..6} using Lx 40
  - H: b0.75 v0.10 c3.20
    - Rerun all using L2_ 30/8 and Lx 40
- [-] L3
  - L: b1.75 v2.50 c3.20
    - ./6,8 fin; rerun rest using Lx 40
  - H: b0.75 v0.10 c3.20
    - ./6,7 fin; rerun rest using Lx 40
- [-] L4
  - L: b2.00 v2.70 c3.20
    - ./8 fin; rerun rest using Lx 40
  - H: b0.75 v0.10 c3.20
...
- (At low D) Once stable inner layer forms, increase is due to
  ...
  - 6 mM is already in this regime; increased screening made it
    possible for conformation with saturated inner layer

- Const p to saturate inner layer? Then what is the lead up at high D,
  just compression? Check if inner layer grows from high D inc
