...
- int_ NFH:  4  mM
  ...
  - int_ NFHf
    - Lx = [78..30..-2]
      - D = 27, 27.113 converged but weird force (25, 26)
        - [ ] Rerun from adjacent
      - [-] D = 34 ~ 38.113 didn't converge (41 ~ 46)
- int_ NFH2: 6  mM
  - Refine D < 50, esp. D < 25
  - int_ NFH2f
    - [-] Lx = [78..30..-2] 
- 50 mM
  - [-] NFH3: Lx = [150, 120, 100, 80, 60, 40, 30, 20]
    - Redo for correct freeE
  - Separated
...
- [-] 1C - 1C (\chi 2.0; p1a4s02/27)
  - [-] 2010: D = [40..30]
    - Do forces 
  - [ ] c1008: D = [XX..XX], (in = 0, 0.90)
    - Fixed Nm to 200; start outlining condensed profile
    - [ ] s{XX}: D = [X..X]
    - After 2010, init sep for FreeE cross
- 1Cd - 1Cd (\alpha 0.2, \chi 0.8?)
- [-] 2C - 2C (\chi 1.75; p2a4s02/9)
  - p2_ 1: D = [50..20..-5]
    - Previous code Nm \ne 200; fixed 02/03 and checking
