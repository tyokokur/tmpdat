...
- [-] 11/07 rerun: (b2v22): 5,6,7,8,9;  b2.2, v1.22 c3.2
  - Note: slightly changed \alpha dist; H-H?
- [-] 11/07 start: b2v2c1: b2.2 v1.22 c3.1
...
Best so far: b5c8v2, b0c8v2, b2c8v3; try to sharpen with \chi
- [X] c0{b0v2, b2v3, b5v2}, c2{b0v2, b2v3, b5v2}
  - c2b2v3 is best. Try mixture to see if sufficient
