...
- int_ NFH3: 50 mM
  - Refine D < 20
  - Possibly first order phase trans?
...
- [-] 1C - 1C (\chi 2.0)
  ...
  - Metastable explore
    - p1_ con: Condensed, init from 8.3; D = [8.4, 8.5, 8.6]
    - p1_ sep: Separated, init from 8.4; D = [8.3, 8.2, 8.1]
    - p1_ sep2: Get to cross F_ con
    - [-] p1_ sep3: Get to cross F_ con
  - [-] p1_ 4: D = [10..20}
