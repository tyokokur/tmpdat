...
/Note:/ Current W_ 7in.dat signifying cp ./7/W_ a* while running 
- L1 (L_ 623, 70 nm^3/s)
  - L: b1.60 v2.00 c3.00
  - H: b0.50 v0.10 c3.00
  - [-] L1_ 30
...
- L3 (L_ 223, 56 nm^3/s)
  ...
  - [-] L3_ 30
    - Redo all from 7
  - [-] L3_ 80
    - ./{6,7} done. Rerun {1..5} from 6
- L4 (L_ 653, 53 nm^3/s)
  - L: b1.60 v1.50 c3.00
  - H: b0.50 /v0.15/ c3.00
  - L4_ 30
    - Wait for L4_ 80 to see if sufficient H vol
  - [-] L4_ 80
...
- pNFH
  ...
  - [-] pH2: b0.50 v0.10 c3.00
    ...
    - Increased H from pH1?
  - [-] pH3: b0.50 v0.20 c3.00
    - Wrong thoughts on v effect on H? Charge density instead of
      charge-carrying volume?
    - Tentatively looks better; work to get ./2 to work. If 2 looks
      good but 1 won't converge, move on
      - Lx changed to 200; bulk Cs large at 150
