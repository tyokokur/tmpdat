...
- Expansion strategy (11/28 start)
  ...
  - CURRENT
    ...
    - Prelim nx,ny = 1 works for arbitrary case [2023-11-28 Tue 17:00]
...
- P relative: 30, 40, 50, 60 (1.23 to 1.67); v05 , v10, v15
  - Pr30v05, Pr30v10, Pr30v15; Pr30/v10/7 RERUN [2023-11-29 Wed 13:54]
  - Pr40v05, Pr40v10, Pr40v15
  - Pr50v05, Pr50v10, Pr50v15
  - Pr60v05, Pr60v10, Pr60v15
...
- 1-1-1: Nx[46..44] (seed p2b/18, Nx42)
  - ./{1..6}
  - ./7,8 [2023-11-22 Wed 15:53]
  
*** p2d
- 1-1: Nx[41..35] (seed p2b/18) 
  - ./1,2: Nx41.8,41.7 (1-1)
  - ./3  : Nx41.6 running, trying most stable (slow) [2023-11-22 Wed 14:27]

*** p2c (seed int_ SYSGp2/5; D30)
- p24C Nx [60..50..-1] 
  - 60..57: 2+2
  - 56    : 3+3
  - 55..52: 2+2 ./9,10,11,12 [2023-11-22 Wed 13:17]
  - 51..50: 1+1+1
  - DONE: ./{1..8; 19..22}
    - {60.2..59} (2-2)
    - {51.2..50} (1-1-1)
