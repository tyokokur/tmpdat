...
- L3 (L_ 223, 56 nm^3/s)
  ...
  - [-] L3_ 30
    - Redo all from 7
  - [-] L3_ 80
    - ./7 done. Rerun all from 7 using wparams 1e-03, 30
- L4 (L_ 653, 53 nm^3/s)
  - L: b1.60 v1.50 c3.00
  - H: b0.50 v0.10 c3.00
  - [-] L4_ 30
    - ./{4..6} redo from 7
  - [-] L4_ 80
    - ./{5,7} done. Rerun all from 7 using wparams 1e-03, 30
...
- pNFH
  - [-] H1: b0.50 v0.13 c3.00
    - Test to see what happens; params previously used for neutral NFH
