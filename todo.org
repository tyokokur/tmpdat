...
* PROG int_ NFH
- 4 mM: int_ NFH
  - int_ NFHf: Lx = [78..30..-2]
  - [ ] ./INT/NFH_ 04 prepped for when intNFH.c fixed
- 6 mM: int_ NFH2
  - int_ NFH2f
    - Lx = [78..30..-2]
- 50 mM: int_ NFH3
  - NFH3: Lx = [150..30]
    - D = {75..20} sep, {17.5..15} con
  - Separated
    - [-] NFH3s: Lx = [36..20..-1]; in=-1; W_ sym20 & W_ sym40
      - D = {18..12.56} finished, {12..10} went to condensed
    - [ ] NFH3s2: Lx = {40, 45, 50, 55, 60}; W_ sym40, W_ sym50, W_ sym60
  - Condensed
    - NFH3f: Lx = [18..10..-1]
    - NFH3c: Lx = [20..50..2]; in=0; 0.80
      - Worked up to D = 23 (24, 25 did not))
      - 
  - NOTE: intNFH3s WA not symmetric
    - Affected: intNFH3s, intNFH3, intNFH3s, intNFH3f, intNFH2f, intNFHf
    - int_ SYSG is fine (checked all previous)
    - [-] Rerun NFH3s/29 in NFH3s/00 using intSYSG (with Nm mod)
...
- [ ] b0.5 v1.00 c3.20 (b5v1c2)
- [ ] b0.5 v1.00 c3.00 (b5v1c3)
- [ ] b0.5 v1.50 c3.20 (b5v5c2)
- [ ] b0.5 v1.50 c3.00 (b5v5c3)
- Failed: in= -1
- Failed: in = 0, 0.40
- Try wopt, wcmp change? Ns0 increase? 
  
** TODO Mixture runs
- L{b2.00 v2.70} + H{b1.00 v050} {c3.20, th2e-02}
  - NLH/EAD*/b2v7c2 + NLH/EAD*/c2/c2b1v3H
- [X] mix80: 80 mol% NFL (0.0200)
  - RERUN after b0 fixed
- [X] mix30: 30 mol% NFL (0.0075)
  - RERUN after b0 fixed
** DONE b = 0.75
- 10/24
  - [X] v0 = 4/3*PI*b^3
...
- [-] 1C - 1C (\chi 2.0; p1a4s02/27)
  ...
  - [-] s{3020}: D = [30..20..-1]
    - init W_ 30 from 4030

- [-] 2C - 2C (\chi 1.75; p2a4s02/9)
  - [-] p2: D = [50..20..-5]
    - Init from int_ SYSGp1/p1_ 2C
