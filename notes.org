...
- (Figure) Overlay on raw charge dist
...
- (Figure?) Vol frac of chains in cond. vs. chains in dilute
  - Sharp collapse caused by most of the chains suddenly going into
    condensed layer
  -
- (Figure?) Free Energy
  - Figure necessary in main body? 
