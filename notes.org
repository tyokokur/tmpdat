...
* Today: To do list
** DONE SYSG update (p3a3)
** DONE Application for QE (CalCentral)
** TODO Scheduling
- Dimitrius ?
- Harsh ?
- Erika GM W 2-4
- Room scheduled with Carlet
- Muhammad okay
- Ahmad okay
** DONE Update wangweb with scholar scrape
** TODO Reflectivity reading
** DONE Propagator derivation
