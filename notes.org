...
- [-] Gaussian chain derivation
  - 3/2 origin, be comfortable with whole derivation, maybe more
    info in supp slides
...
** DONE NFH Update
** TODO NLH Update
*** Update Erika, even if bad

** DONE Website pubs justify text
*** Rui will send "news"

** DONE Quals manu final edits
...
* New papers from New Slides
** Lubrication: multivalent paper
** Surface Tension: multivalent surfactant paper
** Flory Scaling: textbook: Rubinstein, 5.5
** SFBox: Understand lattice-constrained,
